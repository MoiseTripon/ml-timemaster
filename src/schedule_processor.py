...
class ScheduleProcessor:
    ...
    def __init__(self, dpi=500, overlap_threshold=0.7, min_cell_size=5,
                 rotation_confidence_threshold=70.0, minimum_confidence_threshold=50.0,
    ...
    def process(self, file_path):
        ...
        try:
            ...
            grid, num_rows, num_cols = self.table_analyzer.organize_cells_into_grid(result['cells'])
